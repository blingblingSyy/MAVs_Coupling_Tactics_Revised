...
#ifndef _BENCHMARK1_H_    //include guards
#define _BENCHMARK1_H_
...
class Benchmark1: public Model
{
    protected:
        ...
        vector<vector<vector<vector<vector<GRBVar>>>>> f;
        vector<vector<vector<vector<GRBVar>>>> F;
        vector<int> mav_num_type;
    public:
        Benchmark1(Nodes nodes, Vehicles amvs, string modelname, TimeSpace_Network ts_network);
};
